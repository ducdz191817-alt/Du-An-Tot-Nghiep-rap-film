...
const translations = {
  vi: {
    ...
    'about.hero.title': 'Về',
    'about.hero.desc': 'Chúng tôi không chỉ là một hệ thống rạp chiếu phim. Nova Cinema là nơi nghệ thuật điện ảnh gặp gỡ công nghệ hiện đại, mang đến những trải nghiệm xem phim đáng nhớ cho hàng triệu khán giả Việt Nam.',
    'about.hero.exploreMovies': 'Khám phá phim',
    'about.hero.findTheater': 'Tìm rạp gần bạn',

    'about.stat.cinemas': 'Cụm rạp',
    'about.stat.customers': 'Khách hàng tin tưởng',
    'about.stat.showtimes': 'Suất chiếu mỗi tháng',
    'about.stat.rating': 'Đánh giá trung bình',

    'about.mission.badge': 'Sứ mệnh',
    'about.mission.title1': 'Đưa điện ảnh đến',
    'about.mission.title2': 'gần hơn với bạn',
    'about.mission.desc1': 'Nova Cinema được thành lập với sứ mệnh dân chủ hóa trải nghiệm điện ảnh đỉnh cao tại Việt Nam. Chúng tôi tin rằng mọi người đều xứng đáng được thưởng thức bộ phim yêu thích trên màn hình lớn với chất lượng hình ảnh và âm thanh tốt nhất.',
    'about.mission.desc2': 'Từ IMAX 4K đến những suất chiếu sáng tạo theo chủ đề, chúng tôi không ngừng đổi mới để mỗi lần đến rạp là một kỷ niệm đáng nhớ.',

    'about.values.title': 'Giá trị cốt lõi',
    'about.values.subtitle': 'Những nguyên tắc định hình mọi quyết định của chúng tôi',
    'about.values.passion.title': 'Đam mê điện ảnh',
    'about.values.passion.desc': 'Mọi quyết định của chúng tôi đều xuất phát từ tình yêu với nghệ thuật thứ 7 và khát vọng mang đến trải nghiệm xem phim tuyệt vời nhất.',
    'about.values.quality.title': 'Chất lượng & Uy tín',
    'about.values.quality.desc': 'Chúng tôi cam kết duy trì tiêu chuẩn chất lượng cao nhất ở mọi điểm chạm, từ màn hình IMAX đến ghế ngồi, từ âm thanh đến dịch vụ.',
    'about.values.tech.title': 'Công nghệ tiên tiến',
    'about.values.tech.desc': 'Ứng dụng công nghệ mới nhất để tối ưu trải nghiệm đặt vé, quản lý ghế theo thời gian thực và cá nhân hóa gợi ý phim cho từng người.',
    'about.values.service.title': 'Dịch vụ tận tâm',
    'about.values.service.desc': 'Đội ngũ hỗ trợ 24/7 luôn sẵn sàng giải đáp mọi thắc mắc, xử lý phản hồi và đảm bảo bạn có trải nghiệm hoàn hảo từ đầu đến cuối.',

    'about.faq.title': 'Câu hỏi thường gặp',
    'about.faq.subtitle': 'Giải đáp những thắc mắc phổ biến nhất',
    'about.faq.q1': 'Làm sao để đặt vé xem phim trên Nova Cinema?',
    'about.faq.a1': 'Bạn có thể đặt vé qua website hoặc ứng dụng di động. Chọn phim → Chọn suất chiếu → Chọn ghế → Thêm bắp nước (tùy chọn) → Thanh toán online. Cực kỳ nhanh chóng, chỉ vài phút!',
    'about.faq.q2': 'Nova Cinema hỗ trợ những phương thức thanh toán nào?',
    'about.faq.a2': 'Chúng tôi hỗ trợ: Momo, ZaloPay, VNPay, thẻ tín dụng/ghi nợ Visa/Mastercard và thanh toán tiền mặt tại quầy.',
    'about.faq.q3': 'Tôi có thể đổi/hoàn vé sau khi đặt không?',
    'about.faq.a3': 'Vé có thể hoàn trước giờ chiếu 2 giờ. Phí hoàn vé là 20% giá vé. Vé đặt trong chương trình Flash Sale không được hoàn.',
    'about.faq.q4': 'Chính sách thành viên và tích điểm của Nova Cinema?',
    'about.faq.a4': 'Mỗi 10,000đ chi tiêu bạn nhận 1 điểm thưởng. Tích lũy đủ điểm để lên hạng thành viên (Bạc, Vàng, Kim Cương) và nhận ưu đãi độc quyền.',
    'about.faq.q5': 'Nova Cinema có phòng chiếu dành cho trẻ em không?',
    'about.faq.a5': 'Có! Chúng tôi có buổi chiếu Matinee đặc biệt cho gia đình vào buổi sáng cuối tuần với giá vé ưu đãi và không gian thân thiện với trẻ nhỏ.',

    'about.contact.title': 'Cần hỗ trợ?',
    'about.contact.desc': 'Đội ngũ Nova Cinema luôn sẵn sàng lắng nghe và hỗ trợ bạn. Liên hệ với chúng tôi qua các kênh dưới đây.',

    'about.milestone.2019.title': 'Thành lập',
    'about.milestone.2019.desc': 'Nova Cinema ra đời tại Hà Nội với cụm rạp đầu tiên ở Cầu Giấy, mang theo giấc mơ điện ảnh đẳng cấp.',
    'about.milestone.2020.title': 'Vượt qua thử thách',
    'about.milestone.2020.desc': 'Vượt qua thách thức của dịch bệnh, chúng tôi vẫn kiên định với sứ mệnh phục vụ khán giả thủ đô.',
    'about.milestone.2022.title': 'Ra mắt ứng dụng',
    'about.milestone.2022.desc': 'Nền tảng đặt vé trực tuyến chính thức ra mắt, giúp khách hàng đặt vé mọi lúc mọi nơi chỉ với vài chạm.',
    'about.milestone.2023.title': 'Nâng cấp IMAX',
    'about.milestone.2023.desc': 'Nâng cấp màn hình IMAX đầu tiên tại Việt Nam thuộc hệ thống tư nhân tại cụm rạp Hà Nội.',
    'about.milestone.2024.title': '500K khách hàng',
    'about.milestone.2024.desc': 'Cột mốc nửa triệu khách hàng trung thành, khẳng định vị thế thương hiệu điện ảnh hàng đầu tại Việt Nam.',

    'about.team.quote.ceo': '"Điện ảnh không chỉ là giải trí – đó là nghệ thuật kết nối con người."',
    'about.team.quote.coo': '"Chúng tôi không chỉ bán vé – chúng tôi bán những khoảnh khắc đáng nhớ."',
    'about.team.quote.cto': '"Công nghệ giúp nghệ thuật chạm đến nhiều người hơn, nhanh hơn và tiện lợi hơn."',
    'about.team.quote.hoe': '"Mỗi chuyến đến rạp của bạn là một hành trình – chúng tôi muốn nó hoàn hảo."',

    // Theaters Page
    'theaters.badge': 'Hệ thống rạp chiếu phim',
    'theaters.city': 'Hà Nội',
    'theaters.city.short': 'Hà Nội',
    'theaters.address': '123 Hoàng Quốc Việt, Phường Cầu Giấy, Quận Cầu Giấy, Hà Nội',
    'theaters.hero.desc': 'Trải nghiệm điện ảnh đỉnh cao tại chi nhánh Flagship với màn hình chuẩn chiếu phim IMAX, 3D cùng hệ thống âm thanh vòm đỉnh cao.',
    'theaters.contact.title': 'Thông tin liên hệ',
    'theaters.contact.address': 'Địa chỉ chi nhánh',
    'theaters.contact.hotline': 'Hotline liên hệ',
    'theaters.contact.hotlineDesc': 'Đặt vé & giải đáp',
    'theaters.hours.title': 'Giờ hoạt động',
    'theaters.hours.weekday': 'Thứ 2 – Thứ 6',
    'theaters.hours.weekend': 'Thứ 7 – Chủ Nhật',
    'theaters.hours.holiday': 'Lễ & Tết',
    'theaters.rooms.title': 'Các loại phòng chiếu',
    'theaters.room1': 'Phòng 1',
    'theaters.room2': 'Phòng 2',
    'theaters.room3': 'Phòng 3',
    'theaters.room4': 'Phòng 4',
    'theaters.seats': 'ghế',
    'theaters.facilities.title': 'Tiện ích đi kèm',
    'theaters.facility1': 'Bắp rang bơ Nova',
    'theaters.facility2': 'Cocktail bar',
    'theaters.facility3': 'Ghế massage VIP',
    'theaters.facility4': 'Bãi xe ô tô miễn phí',
    'theaters.stat.area': 'Khu vực',
    'theaters.stat.areaDesc': '123 Hoàng Quốc Việt',
    'theaters.stat.screens': 'Số phòng chiếu',
    'theaters.stat.screensUnit': 'Phòng',
    'theaters.stat.seats': 'Tổng ghế ngồi',
    'theaters.stat.seatsUnit': 'Ghế',
    'theaters.stat.seatsDesc': 'Chất lượng cao',
    'theaters.cta': 'Đặt vé xem phim tại đây',
    'theaters.map.title': 'Bản đồ đường đi đến rạp',
  },
  ...
  en: {
    ...
    'about.hero.desc': 'We are more than just a cinema chain. Nova Cinema is where the art of film meets modern technology, delivering unforgettable movie experiences for millions of audiences.',
    'about.hero.exploreMovies': 'Explore Movies',
    'about.hero.findTheater': 'Find a Theater',

    'about.stat.cinemas': 'Cinema Complexes',
    'about.stat.customers': 'Trusted Customers',
    'about.stat.showtimes': 'Showtimes per Month',
    'about.stat.rating': 'Average Rating',

    'about.mission.badge': 'Mission',
    'about.mission.title1': 'Bringing Cinema',
    'about.mission.title2': 'Closer to You',
    'about.mission.desc1': 'Nova Cinema was founded with the mission of democratizing premium cinema experiences in Vietnam. We believe everyone deserves to enjoy their favorite movies on the big screen with the best possible picture and sound quality.',
    'about.mission.desc2': 'From IMAX 4K to creative themed screenings, we continuously innovate so that every visit to the cinema becomes a cherished memory.',

    'about.values.title': 'Core Values',
    'about.values.subtitle': 'The principles that shape every decision we make',
    'about.values.passion.title': 'Passion for Cinema',
    'about.values.passion.desc': 'Every decision we make is driven by our love for the seventh art and our desire to deliver the finest movie-going experience.',
    'about.values.quality.title': 'Quality & Trust',
    'about.values.quality.desc': 'We are committed to maintaining the highest quality standards at every touchpoint — from IMAX screens and seating to sound and service.',
    'about.values.tech.title': 'Advanced Technology',
    'about.values.tech.desc': 'We leverage the latest technology to optimize the booking experience, manage seats in real time, and personalize movie recommendations for each user.',
    'about.values.service.title': 'Dedicated Service',
    'about.values.service.desc': 'Our 24/7 support team is always ready to answer questions, handle feedback, and ensure you have a perfect experience from start to finish.',

    'about.faq.title': 'Frequently Asked Questions',
    'about.faq.subtitle': 'Answers to the most common questions',
    'about.faq.q1': 'How do I book tickets on Nova Cinema?',
    'about.faq.a1': 'You can book tickets via our website or mobile app. Choose a movie → Select a showtime → Pick seats → Add concessions (optional) → Pay online. Super quick, just a few minutes!',
    'about.faq.q2': 'What payment methods does Nova Cinema support?',
    'about.faq.a2': 'We support: Momo, ZaloPay, VNPay, Visa/Mastercard credit/debit cards, and cash payment at the counter.',
    'about.faq.q3': 'Can I exchange or refund my ticket after booking?',
    'about.faq.a3': 'Tickets can be refunded up to 2 hours before showtime. A 20% refund fee applies. Tickets purchased during Flash Sale promotions are non-refundable.',
    'about.faq.q4': 'What is Nova Cinema\'s membership and loyalty points policy?',
    'about.faq.a4': 'You earn 1 reward point for every 10,000 VND spent. Accumulate points to level up your membership tier (Silver, Gold, Diamond) and enjoy exclusive benefits.',
    'about.faq.q5': 'Does Nova Cinema have screenings for children?',
    'about.faq.a5': 'Yes! We offer special family Matinee screenings on weekend mornings with discounted tickets and a child-friendly environment.',

    'about.contact.title': 'Need Support?',
    'about.contact.desc': 'The Nova Cinema team is always here to listen and help you. Reach out to us through the channels below.',

    'about.milestone.2019.title': 'Founded',
    'about.milestone.2019.desc': 'Nova Cinema was born in Hanoi with its first cinema complex in Cau Giay, carrying the dream of premium cinema.',
    'about.milestone.2020.title': 'Overcoming Challenges',
    'about.milestone.2020.desc': 'Despite the challenges of the pandemic, we remained steadfast in our mission to serve audiences in the capital.',
    'about.milestone.2022.title': 'App Launch',
    'about.milestone.2022.desc': 'Our online ticketing platform officially launched, enabling customers to book tickets anytime, anywhere with just a few taps.',
    'about.milestone.2023.title': 'IMAX Upgrade',
    'about.milestone.2023.desc': 'Upgraded to the first privately-owned IMAX screen in Vietnam at our Hanoi cinema complex.',
    'about.milestone.2024.title': '500K Customers',
    'about.milestone.2024.desc': 'Half a million loyal customers — a milestone affirming Nova Cinema as a leading cinema brand in Vietnam.',

    'about.team.quote.ceo': '"Cinema is not just entertainment — it is the art of connecting people."',
    'about.team.quote.coo': '"We don\'t just sell tickets — we sell unforgettable moments."',
    'about.team.quote.cto': '"Technology helps art reach more people, faster and more conveniently."',
    'about.team.quote.hoe': '"Every trip to the cinema is a journey — we want it to be perfect."',

    // Theaters Page
    'theaters.badge': 'Cinema System',
    'theaters.city': 'Hanoi',
    'theaters.city.short': 'Hanoi',
    'theaters.address': '123 Hoang Quoc Viet, Cau Giay Ward, Cau Giay District, Hanoi',
    'theaters.hero.desc': 'Experience world-class cinema at our Flagship branch with IMAX, 3D screens and a premium Dolby Atmos sound system.',
    'theaters.contact.title': 'Contact Information',
    'theaters.contact.address': 'Branch Address',
    'theaters.contact.hotline': 'Hotline',
    'theaters.contact.hotlineDesc': 'Booking & Inquiries',
    'theaters.hours.title': 'Opening Hours',
    'theaters.hours.weekday': 'Mon – Fri',
    'theaters.hours.weekend': 'Sat – Sun',
    'theaters.hours.holiday': 'Public Holidays',
    'theaters.rooms.title': 'Screen Types',
    'theaters.room1': 'Screen 1',
    'theaters.room2': 'Screen 2',
    'theaters.room3': 'Screen 3',
    'theaters.room4': 'Screen 4',
    'theaters.seats': 'seats',
    'theaters.facilities.title': 'Facilities',
    'theaters.facility1': 'Nova Buttered Popcorn',
    'theaters.facility2': 'Cocktail Bar',
    'theaters.facility3': 'VIP Massage Seats',
    'theaters.facility4': 'Free Car Parking',
    'theaters.stat.area': 'Area',
    'theaters.stat.areaDesc': '123 Hoang Quoc Viet',
    'theaters.stat.screens': 'Screens',
    'theaters.stat.screensUnit': 'Screens',
    'theaters.stat.seats': 'Total Seats',
    'theaters.stat.seatsUnit': 'Seats',
    'theaters.stat.seatsDesc': 'Premium quality',
    'theaters.cta': 'Book Tickets Here',
    'theaters.map.title': 'How to Get Here',
  }
};
